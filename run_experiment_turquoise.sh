...
HUMAN_EPI_CONFIG_DIR=`cat $CONFIG_FILE | shyaml get-value EPI_MODEL.CONFIG_DIR`
HUMAN_EPI_CONFIG_FILENAME=`cat $CONFIG_FILE | shyaml get-value EPI_MODEL.CONFIG_FILENAME`
HUMAN_EPI_CONFIG_FILENAME="$HUMAN_EPI_CONFIG_DIR/$HUMAN_EPI_CONFIG_FILENAME"
